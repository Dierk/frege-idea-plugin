...
public class FregeSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(FregeTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(FregeTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(FregeTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(FregeTypes.COMMENT)) {
            return COMMENT_KEYS;
